...
define('CRM_PLUGIN_VERSION', '1.20.146');
...
// (página "Equipo"), sin pasar por wp-admin → Usuarios.
require_once CRM_PLUGIN_PATH . 'includes/equipo-gestion.php';
...
?>
    ...
    top: 0px;">×</button>
        ...
        <?php if ($client_id && function_exists('crm_cliente_render_notificaciones')): ?>
            <div class="crm-section">
                <?php echo crm_cliente_render_notificaciones((int) $client_id); ?>
            </div>
        <?php endif; ?>
