<?php
/*
Plugin Name: Energitel CRM
Description: Sistema de gestión de clientes para Energitel con roles de comercial y administrador.
Version: 1.7
Author: Luis Javier
*/
...
{
    wp_enqueue_style('crm-styles', plugin_dir_url(__FILE__) . 'crm-styles.css', [], '1.7.0', 'all');
}
...
function crm_formulario_alta_cliente()
{
    ...
    wp_enqueue_script('crm-scriptv2', plugins_url('/js/crm-scriptv7.js', __FILE__), array('jquery'), time(), true);
